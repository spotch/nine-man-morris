...
@Ignore
public class NineManMorrisServletEndpointTest {

	HttpServer _httpServer;
	URI _baseUri;
	
	WebResource _testObject;
	...
	public void setup() throws IOException
	{
		...
		Injector injector = Guice.createInjector(new NineManMorrisServletModule());
		...
		_testObject = client.resource(_baseUri);
	}
	...
	{
		ClientResponse clientResponse = _testObject.path("board").get(ClientResponse.class);
	...
	{
		ClientResponse clientResponse = _testObject.path("move").post(ClientResponse.class, "valid move");
	...
	{
		ClientResponse clientResponse = _testObject.path("move").post(ClientResponse.class, "invalid move");
